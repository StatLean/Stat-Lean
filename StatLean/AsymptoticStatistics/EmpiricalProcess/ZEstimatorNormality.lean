...
theorem zEstimator_asymptotic_normality
  ...
  -- specializations of the carried `hψ_meas` / `hψ_L2` — DERIVED, not carried).
  ...
  -- The engine hypothesis bundle, every field DERIVED from the vdV 5.21 hypotheses.
  have hyp : Theorem19_26Hyp P 𝓕 ψ θ₀ (Vlin V) δcls := by
    ...
    · -- hθ₀_mem : `ψ θ₀ h ∈ 𝓕` (needs `δcls > 0`).
      intro h; rw [h𝓕def]; exact ⟨θ₀, hθ₀_ball, h, rfl⟩
