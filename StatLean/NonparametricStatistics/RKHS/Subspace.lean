...
theorem kernelFun_submodule (H₀ : Submodule 𝕜 H) [IsClosed (H₀ : Set H)] (x : X) :
...
theorem scalarKernel_submodule (H₀ : Submodule 𝕜 H) [IsClosed (H₀ : Set H)] (x y : X) :
...
theorem scalarKernel_submodule_inner (H₀ : Submodule 𝕜 H) [IsClosed (H₀ : Set H)] (x y : X) :
    scalarKernel H₀ x y
