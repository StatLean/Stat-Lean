...
| sg-hoeffding        | SubGaussian/Hoeffding.lean                                 | sg-defs                               | GATING  | A    | (merged-to-main, gating)       | 1       | —       | laptop-fixed stray ring (§7.10); gating on main |
...
|---------------------|-------------------------------------------------------------|---------------------------------------|---------|------|--------------------------------|---------|---------|----------------------------------|
| hd-vecnorms         | ForMathlib/VecNorms.lean                                   | —                                     | GATING  | A    | (merged-to-main, gating)       | 1       | —       | rc143 auto-commit 0-sorry; gating on main |
