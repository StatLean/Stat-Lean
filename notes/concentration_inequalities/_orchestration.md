...
| bernstein-mgf       | Bernstein/MGFBound.lean                                    | bernstein-defs                        | MERGED-PARTIAL | A | conc/bernstein-mgf-r2 (merged,UNWIRED) | 2 | 1 | main thm isSubExponential_of_hasBernsteinCondition PROVEN; bernstein_key OPEN SORRY (MGFBound.lean:82, power-series radius Mathlib gap). Constant 2(√σ2∨b) (book 2(σ²∨b) units-wrong, documented). Closer queued. |
