...
| subexp-tail         | SubExponential/TailBounds.lean                            | subexp-defs                           | GATE_FAILED | A | conc/subexp-tailbounds         | 1       | 0       | NEEDS finish-pass: rc143 mid-edit, syntax errs (λ token L81,154) + unsolved goals. Both regime thms present 0-sorry. rm worktree + fresh launch. |
