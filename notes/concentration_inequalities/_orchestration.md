...
| bernstein-mgf       | Bernstein/MGFBound.lean                                    | bernstein-defs                        | MERGED | A | conc/bernstein-key-r17 (merged+wired) | 17 | 0 | bernstein_key CLOSED on Opus (attempt 17, stable SSH) — full MGF power-series bound + integrability. MGFBound 0-sorry, wired. |
...
| mcd-doob            | McDiarmid/DoobDecomposition.lean                         | mcd-condhoeff                         | ACCEPTED_DEBT | B | conc/mcd-doob (merged,UNWIRED) | 6 | 1 | mgf_sub_expectation_le PROVEN; increment_bounded = 1 named sorry = GENUINE Mathlib gap (condDistrib of independent vars needs StandardBorelSpace on coord spaces; ~6 attempts Sonnet+Opus all confirm). DOCUMENTED RESIDUAL DEBT. McDiarmid inequality proven on top. |
...
| hd-ols-exp          | OLS/MSEExpectation.lean                                    | hd-linmodel-defs, sg-hoeffding        | MERGED | A | hds/ols-exp-r1 (merged+wired) | 5 | 0 | E[MSE]≤σ²r/n incl subGaussian_coords (3rd HARD LEMMA) PROVEN on Opus, gated 2856 jobs 0 sorry+clean axioms. |
| hd-ols-hp           | OLS/MSEHighProb.lean                                       | hd-ols-exp, max-l2                    | MERGED | A | hds/ols-hp-r5 (merged+wired) | 5 | 0 | high-prob MSE bound PROVEN on Opus, gated 2868 jobs 0 sorry. thm:mse-ols COMPLETE. HDS AREA COMPLETE (all 3 theorems). subGaussian_coords (3rd hard lemma) done in ols-exp. |
